...
import { Plus, Edit, Trash2, Package, LogOut, Save, X } from 'lucide-react'
...
export default function AdminPage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Add uploaded URLs to images field
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                defaultValue="admin@amershop.com"
              />
            </div>
            <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-4 py-2 border rounded-lg"
                        placeholder="Image URLs (one per line) or upload images above"
                      />
                      <p className="text-xs text-gray-500">
                        Upload images or paste image URLs (one per line)
                      </p>
                    </div>
                  </div>
